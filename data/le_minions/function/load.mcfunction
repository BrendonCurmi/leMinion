...
data modify storage le_minions:stats 1.cobbled_deepslate set value {color: "2828842", profile: {id:[I;-1300865007,-430682384,-1881439081,328251765],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTFmNGYwOTY5NjY4YzM2ZThiNzM5ODE2NWViY2YyYTEzM2NhODhiMmI4YjNiZTZlOWM2Mzg0MzIwZmZiMTUwNyJ9fX0="}]}, name: "§aCobbled Deepslate", block: "cobbled_deepslate", item: "cobbled_deepslate", count: 1, tool: "minecraft:golden_pickaxe", tool2: "minecraft:cobbled_deepslate", sounds: {place: "playsound minecraft:block.stone.place block @a[distance=..20] ~ ~ ~ 1 1 1", break: "playsound minecraft:block.stone.break block @a[distance=..20] ~ ~ ~ 1 1 1"}}
